package com.example.compose_auth.screens.unauthenticated.login

import androidx.compose.runtime.mutableStateOf
import androidx.lifecycle.ViewModel
import com.example.compose_auth.screens.unauthenticated.login.state.LoginErrorState
import com.example.compose_auth.screens.unauthenticated.login.state.LoginState
import com.example.compose_auth.screens.unauthenticated.login.state.LoginUiEvent
import com.example.compose_auth.screens.unauthenticated.login.state.emailOrMobileEmptyErrorState
import com.example.compose_auth.screens.unauthenticated.login.state.passwordEmptyErrorState
